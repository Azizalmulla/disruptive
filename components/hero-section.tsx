  ...
  return (
    <section
      className="flex flex-col items-center text-center relative mx-auto rounded-2xl overflow-hidden my-6 py-0 px-4
         w-full h-[500px] md:h-[600px] lg:h-[810px] md:px-0 pb-4 md:pb-8"
    >
      ...
      <motion.div
        ...
        className="relative z-10 flex flex-col items-center space-y-4 md:space-y-8 lg:space-y-10 mb-4 md:mb-7 lg:mb-9 max-w-md md:max-w-[600px] lg:max-w-[700px] mt-16 md:mt-[120px] lg:mt-[160px] px-4"
      >
        <motion.div
        ...
        >
          <Image
            ...
            width={120}
            height={120}
            className="w-20 md:w-28 lg:w-32 h-auto object-contain max-h-20 md:max-h-28 lg:max-h-32 drop-shadow-lg animate-float"
          />
        </motion.div>
      ...
      <motion.div
        ...
        className="relative z-10 flex flex-row gap-2 md:gap-4 items-center mb-4 md:mb-0 px-4"
      >
        <Link href="#contact" rel="noopener noreferrer">
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button className="font-accent bg-foreground text-background hover:bg-foreground/90 px-4 md:px-8 py-2 md:py-3 rounded-full font-medium text-sm md:text-base shadow-lg hover:shadow-xl transition-all duration-300 animate-glow">
              GET STARTED
            </Button>
          </motion.div>
        </Link>
        <Link href="#contact" rel="noopener noreferrer">
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              variant="outline"
              className="font-accent border-foreground/20 text-foreground hover:bg-foreground/10 px-4 md:px-8 py-2 md:py-3 rounded-full font-medium text-sm md:text-base bg-transparent hover:border-foreground/40 transition-all duration-300"
            >
              BOOK DEMO
            </Button>
          </motion.div>
